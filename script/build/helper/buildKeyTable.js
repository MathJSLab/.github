 ...
 */
export const buildKeyTable = (inputFile, outputFile, declName) => {
    ...
    visit(source);
    /* Generate output */
    const fileContent = `export const ${declName}KeyTable = ${JSON.stringify(keys, null, 4).replace(/\"/gm, "'")} as const;\n`;
